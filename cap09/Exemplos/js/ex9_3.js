...
frm.addEventListener("submit", (e) =>{
    ...
    if(verApostaExiste(peso)){
        alert("Alguém já apostou nesse peso")
        frm.inPeso.focus()
        return
    }
...
frm.btVencedor.addEventListener("click", () =>{
    ...
    const pesoCorreto = Number(prompt("Digite o peso correto: "))
    ...
    let mensagem = `Resultado: Peso Correto - ${pesoCorreto}, Vencedor - ${vencedorNome}, Aposta - ${vencedorPeso}gr`
    alert(mensagem)
})
