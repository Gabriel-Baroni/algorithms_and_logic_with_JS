        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit(salvar)}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="autor" required {... register("autor")}></input>
                </div>
                 <div className="form-group">
                    <label htmlFor="foto">URL da Foto:</label>
                    <input type="text" className="form-control" id="foto" required {... register("foto")}></input>
                </div>
                <div className=" row mt-2">
                    <div className="col-sm-4">
                        <div className="form-group">
                            <label htmlFor="ano">Ano de publicação:</label>
                            <input type="text" className="form-control" id="ano" required {... register("ano")}></input>
                        </div>
                    </div>
                    <div className="col-sm-8">
                        <div className="form-group">
                            <label htmlFor="preco">Preço R$:</label>
                            <input type="text" className="form-control" id="preco" step="0.01" required {... register("preco")}></input>
                        </div>
                    </div>
                </div>
            ...
            <div className={aviso.startsWith("Ok!") ? "alert alert-success" : aviso.startsWith("Erro") ? "alert alert-danger" : ""}> 
                {aviso}
            </div>
        </div>
